...
if (message.channel.type !== 'dm') {
  ...
  .setDescription('Özel mesajdan davet linkini gönderdim, kontrol et! :white_check_mark: :postbox:');
  message.channel.sendEmbed(ozelmesajkontrol) }
const pingozel = new Discord.RichEmbed()
  .setColor(0x00AE86)
  .setTimestamp()
  .setAuthor(message.author.username, message.author.avatarURL)
  .setDescription('Davet Linki: https://discordapp.com/oauth2/authorize?client_id=488480503368908813&scope=bot&permissions=1 :warning:');
